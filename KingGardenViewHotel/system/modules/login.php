...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $row['Password']) && $row['UserStatus'] == 1) {
            ...
            reDirect("/system/modules/dashboard.php");
        } else {
...
<body>
    ...
    <div class="container mt-5 p-5">
        <div class="card">
            <div class="row">
                <div class="col-2 p-4">
                    <a href="/system/index.php"><i class="material-icons">home</i>Back Home</a>
                </div>
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <img src="<?= BASE_URL . '/img/common/mountains_5.png' ?>" alt="mountains_1" style="width:100%; border-radius: 10px;position:absolute;bottom:0;left:0;z-index: 0;">
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?= SYSTEM_BASE_URL ?>js/login.js"></script>
