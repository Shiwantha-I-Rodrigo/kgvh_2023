...
$sort_options = '<option value="i.ItemId">Item Id</option>
...
$range_options = '<option value="i.ItemId">Item Id</option>
<option value="i.ReservationId">Res. Id</option>
<option value="i.ItemPrice">Item Price</option>
<option value="i.ItemPaid">Item Paid</option>
<option value="i.ItemDiscount">Item Discount</option>';
        ...
        <div class="col-7">
            <div class="card mb-4">
                ...
                <div class="d-flex justify-content-between">
                        ...
                        <a href="/system/modules/edit_invoices.php" class="success-btn p-2 m-0 align-items-center"><i class="material-icons">add</i></a>
                    </div>
                    ...
                    <div id="print_page">
                        <div>
                            ...
                            <p class="d-none" style="font-size:2vh;"> INVOICE REPORT</p>
