...
$sort_options = '<option value="i.RoomId">Room Id</option>
...
$range_options = '<option value="i.RoomId">Room Id</option>
<option value="i.RoomPrice">Room Price</option>
<option value="i.RoomCapacity">Room Capacity</option>
<option value="i.RoomStatus">Room Status</option>';
        ...
        <div class="col-7">
            <div class="card mb-4">
                ...
                <div class="d-flex justify-content-between">
                        ...
                        <a href="/system/modules/edit_rooms.php" class="success-btn p-2 m-0 align-items-center"><i class="material-icons">add</i></a>
                    </div>
                    ...
                    <div id="print_page">
                        <div>
                            ...
                            <p class="d-none" style="font-size:2vh;"> ROOM REPORT</p>
