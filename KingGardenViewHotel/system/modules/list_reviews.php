...
$extra_js = '<script src="' . SYSTEM_BASE_URL . 'js/list_reviews.js"></script>';
$extra_css = '';
...
$sort_options = '<option value="i.ReviewId">Review Id</option>
<option value="i.ReservationId">Res. Id</option>
<option value="i.ReviewTitle">Review Title</option>
<option value="i.ReviewStatus">ReviewStatus</option>';

$range_options = '<option value="i.ReservationId">Res. Id</option>';
        ...
        <div class="col-7">
            <div class="card mb-4">
                ...
                <div class="d-flex justify-content-between">
                        ...
                        <a href="/system/modules/edit_reviews.php" class="success-btn p-2 m-0 align-items-center"><i class="material-icons">add</i></a>
                    </div>
                    ...
                    <div id="print_page">
                        <div>
                            ...
                            <p class="d-none" style="font-size:2vh;"> REVIEW REPORT</p>
