...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    extract($_POST);
    $sql = "UPDATE reviews SET `ReservationId`='$reservation_id', `ReviewTitle`='$review_title',`ReviewText`='$review_text', `ReviewStatus`='$review_status'  WHERE ReviewId=$review_id";
    $db->query($sql);
