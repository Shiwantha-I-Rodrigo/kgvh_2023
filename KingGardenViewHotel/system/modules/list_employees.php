...
$extra_js = '<script src="' . SYSTEM_BASE_URL . 'js/list_employees.js"></script>';
$extra_css = '';
        ...
        <div class="col-7">
            <div class="card mb-4">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="my-4 text-center"><label class="my-1" style="font-size : 2vh;">EMPLOYEES</label></div>
                    <div id="print_page">
                        <div>
                            <img class="d-none" style="height:8vh;" src="<?= BASE_URL . '/img/common/logo_logo.png' ?>" alt="logo">
                            <p class="d-none" style="font-size:2vh;"> EMPLOYEE REPORT</p>
